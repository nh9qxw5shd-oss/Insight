...
// Daily series 25 May – 20 Jul 2026: [date, incidents, delay-min, level, Route T3 %]
// T3 is the previous-day end-of-day figure from the 05:30 messaging snapshot
// (metrics_for_date attribution); null = no snapshot for that day.
const TIMELINE: [string, number, number, keyof typeof L | null, number | null][] = [
  ['2026-05-25', 56, 4771, 'E', 68.3], ['2026-05-26', 66, 9584, 'E', 68.3], ['2026-05-27', 50, 1390, 'D', 73.2], ['2026-05-28', 38, 2980, 'E', 63.5],
  ['2026-05-29', 48, 1954, 'D', 76.4], ['2026-05-30', 33, 488, 'E', 80.9], ['2026-05-31', 36, 1538, 'A', 80.4], ['2026-06-01', 36, 980, 'A', 77.5],
  ['2026-06-02', 53, 5089, 'D', 68.8], ['2026-06-03', 43, 1941, 'A', 75.3], ['2026-06-04', 74, 4665, 'D', 78.8], ['2026-06-05', 34, 1469, 'G', 77.8],
  ['2026-06-06', 30, 1618, 'D', 77.2], ['2026-06-07', 24, 423, 'A', 75.8], ['2026-06-08', 38, 2309, 'A', 76.9], ['2026-06-09', 29, 1134, 'D', 82.2],
  ['2026-06-10', 46, 1534, 'D', 77.2], ['2026-06-11', 38, 1655, 'G', 81.5], ['2026-06-12', 35, 2160, 'A', 79.1], ['2026-06-13', 24, 1638, 'A', 83.6],
  ['2026-06-14', 57, 888, 'A', 87.1], ['2026-06-15', 30, 1018, null, 77.8], ['2026-06-16', 38, 3441, 'A', 77.9], ['2026-06-17', 56, 2787, 'A', 74.6],
  ['2026-06-18', 43, 1902, 'D', 75.4], ['2026-06-19', 42, 435, 'E', 75.4], ['2026-06-20', 24, 3692, 'D', 77.1], ['2026-06-21', 29, 1382, 'E', 78.7],
  ['2026-06-22', 63, 6575, 'E', 66.2], ['2026-06-23', 101, 7367, 'E', 67.8], ['2026-06-24', 50, 2526, 'E', 57.2], ['2026-06-25', 51, 2987, 'E', 65.9],
  ['2026-06-26', 46, 3230, 'E', 52.2], ['2026-06-27', 53, 1940, 'E', 62.5], ['2026-06-28', 31, 449, 'D', 77.7], ['2026-06-29', 48, 1160, 'A', 73.4],
  ['2026-06-30', 38, 2466, 'D', 68.1], ['2026-07-01', 44, 1881, 'G', 79.3], ['2026-07-02', 50, 3280, 'D', 76.6], ['2026-07-03', 42, 1977, 'D', 78.8],
  ['2026-07-04', 34, 2259, 'E', 75.7], ['2026-07-05', 31, 1954, 'E', 74.4], ['2026-07-06', 27, 607, 'E', 75.1], ['2026-07-07', 51, 4415, 'E', null],
  ['2026-07-08', 57, 9329, 'E', 55.9], ['2026-07-09', 45, 2029, 'E', 60.3], ['2026-07-10', 33, 2748, 'E', 66.1], ['2026-07-11', 25, 2025, 'E', 74.1],
  ['2026-07-12', 18, 170, 'E', 67.2], ['2026-07-13', 37, 1847, 'E', 66.3], ['2026-07-14', 30, 3283, 'E', 69.3], ['2026-07-15', 27, 1309, 'E', 78.6],
  ['2026-07-16', 19, 65, 'E', 78.1], ['2026-07-17', 34, 1232, 'E', 77.6], ['2026-07-18', 25, 1376, 'D', 77.5], ['2026-07-19', 31, 1320, 'A', 79.2],
  ['2026-07-20', 47, 1193, 'D', 74.5],
]
...
export const HEATWAVE_EXAMPLE_PINS: BriefingPin[] = [
  ...
  ex(4, {
    kind: 'timeline',
    title: 'Eight weeks in one look — daily incidents vs Route T3, banded by weather level',
    comment: 'The 14-day Extreme run (4–17 Jul) sits at the right; the late-June Extreme cluster carried the biggest single-day spike (101 incidents, 23 Jun) and dragged Route T3 to its floor of 52.2% (26 Jun). T3 uses the previous-day end-of-day figure from the 05:30 snapshot.',
    source_label: 'Worked example · Overview · Daily Activity',
    window_from: '2026-05-25', window_to: '2026-07-20', filters_summary: 'none',
    payload: {
      days: TIMELINE.map(([date, incidents, delayMins, l, t3]) => ({ date, incidents, delayMins, level: l ? L[l] : null, t3 })),
      t3Target: 71.5,
    },
  }),
  ex(5, {
